...
from Classes.ExtendedAnswer import ExtendedAnswer

SINGLE_ANSWER_Q_FILE = "questions\single_answer.json"
MULTIPLE_CHOICE_Q_FILE = "questions\multiple_choice.json"
EXTENDED_ANSWER_Q_FILE = "questions\extended_answer.json"
...
class QuestionHandler():
    ...
    def create_extended_answer_question_objects(self):
        question_data = self.load_questions(EXTENDED_ANSWER_Q_FILE)
        question_array = question_data['questionsList']
        print(question_array)
        ...
        for q in question_array:
            ...
            new_question = ExtendedAnswer(q_id, question, topic, "short", marks)
            question_objects.append(new_question)
